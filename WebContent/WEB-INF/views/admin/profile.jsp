...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="${pageContext.servletContext.contextPath}/admin/newaccount.htm"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> New Account Employee</a></li>
			<li class="parent ">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="panel panel-info " style="margin-bottom: 15px">
						  <div class="panel-body">
						  	<form role="form" action="${pageContext.servletContext.contextPath}/admin/editprofile.htm" method="get">
						<fieldset>
							<div class="form-group">
							<p>Username</p>
								<input disabled="disabled" class="form-control" id = "username" name="username" type="text" autofocus="" value = "${myaccount.accountId }">
							</div>
							
							<div class="form-group">
							<p>Email</p>
								<input disabled="disabled" class="form-control" id = "email" name="email" type="email" autofocus="" value = "${myaccount.email }">
							</div>
							
							<div class="form-group">
							<p>Full Name</p>
								<input class="form-control" disabled="disabled" id = "name" name="name" type="text" autofocus="" value = "${myaccount.name }">
							</div>
							
							<div class="form-group">
							<p>Số điện thoại</p>
								<input class="form-control" disabled="disabled" id = "phone" name="phone" type="number" autofocus="" value = "${myaccount.phone }">
							</div>
							
							<div class="form-group">
							<p>Địa chỉ</p>
								<input class="form-control" disabled="disabled" id = "address" name="address" type="text" autofocus="" value = "${myaccount.address }">
							</div>
