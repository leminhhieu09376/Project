				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="panel panel-info " style="margin-bottom: 15px">
						  <div class="panel-body">
						  	<form role="form" action="${pageContext.servletContext.contextPath}/admin/editprofile.htm" method="post">
						<fieldset>
							<div class="form-group">
							<p>Username</p>
							...
							<div class="form-group">
							<p>Email</p>
								<input class="form-control" placeholder="nguyenvana@gmail.com" id = "email" name="email" type="email" value = "${myaccount.email }">
							</div>
							
							<div class="form-group">
							<p>Full Name</p>
								<input class="form-control" placeholder="Nguyễn Văn A" id = "name" name="name" type="text" value = "${myaccount.name }">
							</div>
							
							<div class="form-group">
							<p>Số điện thoại</p>
								<input class="form-control" placeholder="0337874433" id = "phone" name="phone" type="number" value = "${myaccount.phone }">
							</div>
